...
import API from '../../api';
import WeatherForcastPrefilled from '../WeatherForcast/weatherForcastPrefilled';
import Forest from '../../assets/Forest.mp4';
import Clouds from '../../assets/Clouds.mov';
import Header from '../../components/Header/header';
import './home.css';

export default class HomePagePrefilled extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            loggedIn: false,
